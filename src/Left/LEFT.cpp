...
SC_MODULE(LEFT)
{
	...
	LEFT(sc_module_name name, const sc_signal<bool>& _clk, const sc_signal<bool>& _reset, const sc_signal<bool>& _enable, float* _ram_source, float* _ram_dest1, float* _ram_dest2, float* _ram_dest3):
		dma_mm2s("internal_mm2s", DmaDirection::MM2S, _clk, _reset, _enable, _ram_source, stream_bus),
		dma_s2mm1("internal_s2mm1", DmaDirection::S2MM, _clk, _reset, _enable, _ram_dest1, stream_bus),
		dma_s2mm2("internal_s2mm2", DmaDirection::S2MM, _clk, _reset, _enable, _ram_dest2, stream_bus),
		dma_s2mm3("internal_s2mm3", DmaDirection::S2MM, _clk, _reset, _enable, _ram_dest3, stream_bus)
	{
